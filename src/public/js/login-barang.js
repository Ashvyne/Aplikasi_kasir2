/**
 * LOGIN - STAFF BARANG (ITEM USER)
 * Mengirim role='item_user' ke backend
 * Backend WAJIB validasi role match
 */

const LOGIN_ROLE = 'item_user';  // Staff Barang role
...
async function handleLogin(e) {
  ...
  try {
    ...
    if (loginBtn) {
      ...
      loginBtn.innerHTML = '<i class="bi bi-box-arrow-in-right"></i> Login Staff Barang';
    }
  }
}
